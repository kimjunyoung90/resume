...
- **고객사·영업·사내 타 부서 요구사항 분석 및 정책 검토**
- **외부 고객사 API 연동 지원 및 연동 가이드 문서화**
- **국세청 전송 시스템 연동 데이터 적재**
- **MSA 환경의 포인트·결제 서비스 연동 및 보상 트랜잭션 설계**
- **AOP 기반 권한 검증 공통 모듈 설계 및 적용**
- **테이블·인덱스 설계 및 쿼리 성능 최적화**
- **APM·ELK 활용 장애 대응 및 국세청 전송 실패 등 운영 이슈 처리**
- **사용자 화면 개발 및 프론트 레거시 개선**
- **로깅 체계 통합 등 기술 부채 해소**
- **8대 서버 무중단 순차 배포**
...
- 쿠폰은 회사 단위로 발급되고, 같은 회사 소속 직원이 동일한 쿠폰을 함께 사용할 수 있는 구조
